...
void FMapUtils::MakeG16Texture(int32 TextureWidth, uint16* HeightData, FString CacheTextureName, TFunction<void(UTexture2D*)> Callback)
{
...
UTexture2D* FMapUtils::LoadCachedTexture(FString CacheTextureName)
{
